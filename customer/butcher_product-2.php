    ...
    <div class="container product-container">
        ...
        <div class="product-image-col">
            <div class="main-image">
                <img src="assets/images/Beef Sausages.png" alt="Beef Sausages">
            </div>
        </div>

        <!-- Right Column: Details -->
        <div class="product-info-col">
            <h1 class="product-title">Beef Sausages</h1>
            ...
            <div class="product-meta">
                <div class="meta-row">
                    ...
                    <span class="meta-value">BCH-002</span>
                </div>
                <div class="meta-row">
                    <span class="meta-label">CATEGORY</span>
                    <span class="meta-value text-orange">Butchers</span>
                </div>
            </div>
        </div>
    </div>
