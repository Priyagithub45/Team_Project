    ...
    <div class="container product-container">
        ...
        <div class="product-image-col">
            <div class="main-image">
                <img src="assets/images/Pacific Octopus.png" alt="Pacific Octopus">
            </div>
        </div>

        <!-- Right Column: Details -->
        <div class="product-info-col">
            <h1 class="product-title">Pacific Octopus</h1>
            ...
            <div class="product-meta">
                <div class="meta-row">
                    ...
                    <span class="meta-value">FSH-004</span>
                </div>
                <div class="meta-row">
                    <span class="meta-label">CATEGORY</span>
                    <span class="meta-value text-orange">Fishmongers</span>
                </div>
            </div>
        </div>
    </div>
