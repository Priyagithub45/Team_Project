    ...
    <div class="container product-container">
        ...
        <div class="product-image-col">
            <div class="main-image">
                <img src="assets/images/Croissants.png" alt="Croissants">
            </div>
        </div>

        <!-- Right Column: Details -->
        <div class="product-info-col">
            <h1 class="product-title">Croissants</h1>
            ...
            <div class="product-meta">
                <div class="meta-row">
                    ...
                    <span class="meta-value">BAK-002</span>
                </div>
                <div class="meta-row">
                    <span class="meta-label">CATEGORY</span>
                    <span class="meta-value text-orange">Bakery</span>
                </div>
            </div>
        </div>
    </div>
